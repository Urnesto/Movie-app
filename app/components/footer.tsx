...
<>
<section>
    <div className=" w-md  h-fit placeholde md:h-96 grid justify-items-center bg-slate-200">
   <div className=" flex flex-col md:flex-row  my-10 md:space-x-10  space-y-4 ">
